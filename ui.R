           ...
           tabPanel("Effect size estimation", # name of the Tab 
                    ...
                    tabsetPanel(type = "pills", 
                                ...
                                tabPanel("Meta-analysis output", 
                                         selectInput("typeofmeta","Type of meta-analysis", c("Choose type of meta-analysis","Fixed-effect","Random-effects")),
                                         conditionalPanel("input.typeofmeta =='Fixed-effect'",  
                                                          selectInput("MH_or_IV","Choose weighting method",choices = c("Choose weighting method","Mantel-Haenszel method","Inverse variance") )),
